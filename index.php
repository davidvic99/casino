...
var dado = Math.floor((Math.random() * 6) + 1);
      var cartera = prompt("Añade saldo a tu cartera");
      ...
      var dinero = prompt("Introduce tu dinero de juego ");
      var dincasino =  dinero;
      var dineroactual = 50;
      if(dineroactual < dinero) {
        alert("No puedes usar esa cantidad porque supera nuestro limite")
      }
      else {
        alert("Tu apuesta es" + " " + dinero + "€" );
         ...
         alert("Tu dinero actual es " + dinero2 + "€" );
          alert("tu dinero en la cartera es" + cartera1);
             var dinero3=dinero2;
